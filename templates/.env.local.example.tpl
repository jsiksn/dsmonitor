# dsmonitor 환경 변수 — 본 파일은 `dsmonitor init` 안 자동 생성됨 (v0.1.0).
...
# FIGMA_API_TOKEN=figd_<personal access token>

# ────── Lighthouse (lighthouse 측정 활용 시점에만) ──────
# LIGHTHOUSE_BASE_URL=http://localhost:3000
# LIGHTHOUSE_TEST_ID=<선택, 인증 어댑터 활용>
# LIGHTHOUSE_ZONE_ACCOUNT_LABEL=<선택>
